...
const MONGODB_URI =
  "mongodb+srv://<user>:<pass>@cluster0.ykiwddm.mongodb.net/?retryWrites=true&w=majority";

async function connectDb() {
  await mongoose.connect(
    "mongodb+srv://shakhovworking:onecheck13@cluster0.ykiwddm.mongodb.net/?retryWrites=true&w=majority",
  );
